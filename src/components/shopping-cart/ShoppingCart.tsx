...
function ShoppingCart() {
  return (
    <div className="fixed inset-0 z-60 bg-black/80">
      <section className="fixed lg:top-0 lg:w-123 lg:h-full z-80 bg-white px-6 py-6 flex flex-col overflow-x-hidden bottom-0 left-0 right-0 mt-24 lg:mt-0 lg:left-auto focus:outline-none">
        ...
        <div className="flex flex-col max-h-[calc(100dvh-64px)]">
          <div className="overflow-y-scroll border-b border-grey">
            <div className="justify-center pb-4 lg:pb-10 border-b border-grey mb-4"></div>
